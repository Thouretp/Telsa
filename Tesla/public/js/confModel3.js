...
if(document.getElementById('modelYPerformance').checked){
    modeleChoisi = document.getElementById('modelYPerformance').value;
    document.getElementById('afficheModel').innerHTML = modeleChoisi
    document.getElementById('bouton_modelY').style.backgroundColor="rgb(101, 77, 255)"
}
else{
    document.getElementById('bouton_modelY').style.backgroundColor="#121212"}
