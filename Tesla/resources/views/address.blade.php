    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('address') }}">
            ...
            <div>
                ...
                <x-text-input id="inputRue" class="form-control block mt-1 w-full" type="text" name="inputRue" :value="old('adresserue')" required autofocus  />
            ...
            <div>
                ...
                <x-text-input id="inputVille" class="form-control block mt-1 w-full" type="text" name="inputVille" :value="old('ville')" required autofocus />
            ...
            <div>
                ...
                <x-text-input id="inputCodePostal" class="form-control block mt-1 w-full" type="text" pattern="^[0-9]{1}[0-9a-bA-B]{1}[0-9]{3}$" minlength="5" maxlength="5" name="cp" :value="old('cp')" required autofocus />
