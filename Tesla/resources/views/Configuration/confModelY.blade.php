        ...
        <div class="options">
                ...
                <div class="contenu">
                    ...
                    <fieldset >
                        ...
                        <div class="boutons__options">
                            ...
                            <label class="label__clickable" id ="bouton_modelX" for="modelXstandart">Model Y Grande Autonomie</label><br>
                        </div>
            ...
            <div class="interieur">
                ...
                <fieldset>
                    ...
                    <div>
                        <input class="radio__options" type="radio" name="interieur" id="interieur3" value="{{$optionCouleurMY[10]->detailcaracteristique}}">
