                ...
                <div class="contenu">
                    ...
                    <input type="button" id="more_info1" class="more_info" value="i"></input>
                        <div class="boutons__options">
                            <input class="radio__options" type="radio" name="model" id="modelPlaid" value="Model X Plaid" checked="checked"></input>
                            <label class="label__clickable" id="bouton_modelX_plaid"for="modelPlaid" title="Model X Plaid">Modele X Plaid</label><br>
                        </div>

                        <div class="boutons__options">
                            <input class="radio__options"type="radio" name="model" id="modelXstandart" value="Model S" >
                            <label class="label__clickable" id ="bouton_modelX" for="modelXstandart" title="Model S">Modèle X</label><br>
                        </div>
                    </fieldset>
            ...
            <div class="couleurs">
                ...
                <input type="button" id="more_info2" class="more_info" value="i"></input>
                    <div class="d__flex">
                        ...
                        <label  for="blanc"><div id="white" class="W" title="{{$optionCouleurMX[0]->detailcaracteristique}}"></div></label>
                    </div>
                    
                    <div class="d__flex">
                        <input class="radio__options" type="radio" name="color" id="bleu" value="{{$optionCouleurMX[3]->detailcaracteristique}}" >
                        <label for="bleu"><div id="blue"  class="Blue" title="{{$optionCouleurMX[3]->detailcaracteristique}}"></div></label>
                    </div>
                    <div class="d__flex">
                        <input class="radio__options"  type="radio" name="color" id="gris" value="{{$optionCouleurMX[2]->detailcaracteristique}}" >
                        <label  for="gris"><div id="grey" class="G" title="{{$optionCouleurMX[2]->detailcaracteristique}}"></div></label>
                    </div>
                    <div class="d__flex">
                        <input class="radio__options" type="radio" name="color" id="noir" value="{{$optionCouleurMX[1]->detailcaracteristique}}" >
                        <label  for="noir"><div  id="black" class="Black" title="{{$optionCouleurMX[1]->detailcaracteristique}}"></div></label>
                    </div>
                    <div class="d__flex">
                        <input class="radio__options" type="radio" name="color" id="rouge" value="{{$optionCouleurMX[4]->detailcaracteristique}}" >
                        <label  for="rouge"><div id="red" class="R" title="{{$optionCouleurMX[4]->detailcaracteristique}}"></div></label>
                    </div>
                </fieldset>
            ...
            <div class="jantes">
                ...
                <input type="button" id="more_info3" class="more_info" value="i"></input>
                    <div>  
                        ...
                        <label class="label__clickable" id="bouton_jantes1"for="jantes1" title="{{$optionDescMX[6]->description_option}}">{{$optionDescMX[5]->description_option}}</label><br>
                    </div>
                    <div>
                        <input class="radio__options" type="radio" name="jantes" id="jantes2" value="{{$optionDescMX[6]->description_option}}" >
                        <label class="label__clickable" id="bouton_jantes2" for="jantes2" title="{{$optionDescMX[6]->description_option}}">{{$optionDescMX[6]->description_option}}</label><br>
                    </div>
                </fieldset>
            ...
            <div class="interieur">
                ...
                <input type="button" id="more_info4" class="more_info" value="i"></input>
                    <div>
                        ...
                        <label  for="interieur1"><div id="bouton_interieur_1" class="Black2" title="{{$optionCouleurMX[8]->detailcaracteristique}}"></div></label><br>
                    </div>
                    <div>
                        <input class="radio__options" type="radio" name="interieur" id="interieur2" value="{{$optionCouleurMX[9]->detailcaracteristique}}">
                        <label  for="interieur2"><div id="bouton_interieur_2"class="W2" title="{{$optionCouleurMX[9]->detailcaracteristique}}"></div></label><br>
                    </div>
                    <div>
                        <input class="radio__options" type="radio" name="interieur" id="interieur3" value="{{$optionCouleurMX[10]->detailcaracteristique}}">
                        <label  for="interieur3"><div id="bouton_interieur_3" class="Beige" title="{{$optionCouleurMX[10]->detailcaracteristique}}"></div></label><br>
                    </div>
                </fieldset>
