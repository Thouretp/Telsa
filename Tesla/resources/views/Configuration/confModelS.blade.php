        ...
        <div class="options">
                ...
                <div class="contenu">
                    ...
                    <input type="button" id="more_info1" class="more_info" value="i"></input>
                        <div class="boutons__options">
                            <input class="radio__options" type="radio" name="model" id="modelPlaid" value="Modèle S Plaid" checked="checked"></input>
                            <label class="label__clickable" id="bouton_modelX_plaid"for="modelPlaid" title="Model S Plaid">Model S Plaid</label><br>
                        </div>

                        <div class="boutons__options">
                            <input class="radio__options"type="radio" name="model" id="modelXstandart" value="Modèle S" >
                            <label class="label__clickable" id ="bouton_modelX" for="modelXstandart" title="Model S">Model S</label><br>
                        </div>
                    </fieldset>
            ...
            <div class="couleurs">
                ...
                <input type="button" id="more_info2" class="more_info" value="i"></input>
                    <div class="d__flex">
                        ...
                        <label  for="blanc"><div id="white" class="W" title="{{$optionCouleurMS[0]->detailcaracteristique}}"></div></label>
                    </div>
                    
                    <div class="d__flex">
                        <input class="radio__options" type="radio" name="color" id="bleu" value="{{$optionCouleurMS[3]->detailcaracteristique}}" >
                        <label for="bleu"><div id="blue"  class="Blue" title="{{$optionCouleurMS[3]->detailcaracteristique}}"></div></label>
                    </div>
                    <div class="d__flex">
                        <input class="radio__options"  type="radio" name="color" id="gris" value="{{$optionCouleurMS[2]->detailcaracteristique}}" >
                        <label  for="gris"><div id="grey" class="G" title="{{$optionCouleurMS[2]->detailcaracteristique}}"></div></label>
                    </div>
                    <div class="d__flex">
                        <input class="radio__options" type="radio" name="color" id="noir" value="{{$optionCouleurMS[1]->detailcaracteristique}}" >
                        <label  for="noir"><div  id="black" class="Black" title="{{$optionCouleurMS[1]->detailcaracteristique}}"></div></label>
                    </div>
                    <div class="d__flex">
                        <input class="radio__options" type="radio" name="color" id="rouge" value="{{$optionCouleurMS[4]->detailcaracteristique}}" >
                        <label  for="rouge"><div id="red" class="R" title="{{$optionCouleurMS[4]->detailcaracteristique}}"></div></label>
                    </div>
                </fieldset>
            ...
            <div class="jantes">
                ...
                <input type="button" id="more_info3" class="more_info" value="i"></input>
                    <div>  
                        <input class="radio__options" type="radio" name="jantes" id="jantes1" value="{{$optionDescMS[5]->description_option}}" checked="checked">
                        <label class="label__clickable" id="bouton_jantes1"for="jantes1" title="{{$optionDescMS[5]->description_option}}">{{$optionDescMS[5]->description_option}}</label><br>
                    </div>
                    <div>
                        <input class="radio__options" type="radio" name="jantes" id="jantes2" value="{{$optionDescMS[6]->description_option}}" >
                        <label class="label__clickable" id="bouton_jantes2" for="jantes2" title="{{$optionDescMS[6]->description_option}}">{{$optionDescMS[6]->description_option}}</label><br>
                    </div>
                </fieldset>
            ...
            <div class="interieur">
                ...
                <input type="button" id="more_info4" class="more_info" value="i"></input>
                    <div>
                        <input class="radio__options" type="radio" name="interieur" id="interieur1" value="{{$optionCouleurMS[8]->detailcaracteristique}}" checked="checked">
                        <label  for="interieur1"><div id="bouton_interieur_1" class="Black2" title="{{$optionCouleurMS[8]->detailcaracteristique}}"></div></label><br>
                    </div>
                    <div>
                        <input class="radio__options" type="radio" name="interieur" id="interieur2" value="{{$optionCouleurMS[9]->detailcaracteristique}}">
                        <label  for="interieur2"><div id="bouton_interieur_2"class="W2" title="{{$optionCouleurMS[9]->detailcaracteristique}}"></div></label><br>
                    </div>
                    <div>
                        <input class="radio__options" type="radio" name="interieur" id="interieur3" value="{{$optionCouleurMS[10]->detailcaracteristique}}">
                        <label  for="interieur3"><div id="bouton_interieur_3" class="Beige" title="{{$optionCouleurMS[10]->detailcaracteristique}}"></div></label><br>
                    </div>
                </fieldset>
