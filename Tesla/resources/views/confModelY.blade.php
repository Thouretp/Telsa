@include('header')
        ...
        <div class="options">
            ...
            <div class="motorisation" id="motorisation">
                ...
                <div class="contenu">
                    ...
                    <div class="boutons">
                        <button class="btn">Model Y plaid <a>132 900€</a></button> <br>
                        <button class="btn">Model Y </button>
                    </div>
  ...
  <fieldset id="zebi">
    ...
    <label for="modelPlaid">Model Y PLAID</label><br>

    <input type="radio" name="model" id="modelXstandart" value="Modèle X" >
    <label for="modelXstandart">Model Y</label><br>
