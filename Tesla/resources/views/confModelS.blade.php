                ...
                <div class="contenu">
                    ...
                    <fieldset >
                        <div class="boutons__options">
                            ...
                            <label class="label__clickable" id="bouton_modelX_plaid"for="modelPlaid">Modele S Plaid</label><br>
                        </div>

                        <div class="boutons__options">
                            <input class="radio__options"type="radio" name="model" id="modelXstandart" value="Modèle S" >
                            <label class="label__clickable" id ="bouton_modelX" for="modelXstandart">Modèle S</label><br>
                        </div>
                    </fieldset>
