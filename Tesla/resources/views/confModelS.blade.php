                ...
                <div class="contenu">
                    ...
                    <fieldset >
                        <div class="boutons__options">
                            ...
                            <label class="label__clickable" id="bouton_modelX_plaid"for="modelPlaid">Modele S Plaid 209 000€</label><br>
                        </div>

                        <div class="boutons__options">
                            <input class="radio__options"type="radio" name="model" id="modelXstandart" value="Modèle S" >
                            <label class="label__clickable" id ="bouton_modelX" for="modelXstandart">Model S <span class="italic">(2023)</span></label><br>
                        </div>
            ...
            <div class="jantes">
                ...
                <fieldset>
                    <div>  
                        ...
                        <label class="label__clickable" id="bouton_jantes1"for="jantes1">{{$optionDescMS[5]->description_option}}</label><br>
                    </div>
                    <div>
                        <input class="radio__options" type="radio" name="jantes" id="jantes2" value="{{$optionDescMS[6]->description_option}}" >
                        <label class="label__clickable" id="bouton_jantes2" for="jantes2">{{$optionDescMS[6]->description_option}}</label><br>
                    </div>
                </fieldset>
